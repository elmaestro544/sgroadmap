...
// Main App Component
const App = () => {
  // FIX: Widen the types for `view` and `language` state from a specific literal
  // to `string` to allow for multiple possible values and prevent comparison errors.
  const [view, setView] = useState<string>(AppView.Research);
